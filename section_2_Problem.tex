...
\end{enumerate}
Unlike traditional EMO, here our goal is not to approximate the Pareto front (PF). Rather, we try to design a special-purpose EMO algorithm which is able find a tree-space containing highly accurate species trees.
